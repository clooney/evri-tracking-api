Evri Tracking API - PHP
================================
Use PHP to track Evri shipments with Evri Tracking API.
...
Create a tracking (Real-time tracking):
      ...
      try {
        $params = ['tracking_number'=>'hermes-uk','courier_code'=>'hermes-uk'];
...
Create trackings (Max. 40 tracking numbers create in one call):
        ...
        try {
            $params = [
                ['tracking_number'=>'H001EA0111477070','courier_code'=>'hermes-uk'],
                ['tracking_number'=>'H0526A0006382298','courier_code'=>'hermes-uk']
            ];
...
Get status of the shipment:
    ...
    try {
        $params = ['courier_code'=>'hermes-uk','created_date_min'=>'2023-08-23T06:00:00+00:00','created_date_max'=>'2023-09-05T07:20:42+00:00'];
...
Update a tracking by ID:
    ...
    try {
        ...
        $idString = '97a7b2ce9e626b2efccee02e084efe91';
