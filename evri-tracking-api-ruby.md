...
Create a tracking (Real-time tracking):
      ...
      begin
        params  = {"tracking_number" => "H001EA0111477070","courier_code"=>"hermes-uk"}
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    begin
      params  = [{"tracking_number" => "H0526A0006382298","courier_code"=>"hermes-uk"},{"tracking_number" => "HZYEJA0393647455","courier_code"=>"hermes-uk"}]
...
Get status of the shipment:
    ...
    begin
      ...
      # params  = {"courier_code"=>"hermes-uk"}
      # params  = {"tracking_numbers" => "H0526A0006382298,H001EA0111477070","courier_code"=>"hermes-uk"}
...
Update a tracking by ID:
    ...
    begin
      ...
      id_string = '97a7b2ce9e626b2efccee02e084efe91'
