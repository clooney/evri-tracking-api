Evri Tracking API - .Net
================================
Use .Net to track Evri shipments with Evri Tracking API.
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  createTrackingParams.trackingNumber = "HZYEJA0393647455";
                  createTrackingParams.courierCode = "hermes-uk";
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  {
                      trackingNumber = "H001EA0111477070",
                      courierCode = "hermes-uk"
                  };
                  ...
                  {
                      trackingNumber = "H0526A0006382298",
                      courierCode = "hermes-uk"
                  };
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  # getTrackingResultsParams.trackingNumbers = "H0526A0006382298,H001EA0111477070";
                  getTrackingResultsParams.courierCode = "hermes-uk";
