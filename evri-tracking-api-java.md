Evri Tracking API - Java
================================
Use Java to track Evri shipments with Evri Tracking API.
...
Create a tracking (Real-time tracking):
    ...
    package com.trackingmore.example.hermesuk;
    ...
    public class CreateEvriTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams.setTrackingNumber("H0526A0006382298");
                createTrackingParams.setCourierCode("hermes-uk");
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    public class CreateEvriTrackingsExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams1.setTrackingNumber("HZYEJA0393647455");
                createTrackingParams1.setCourierCode("hermes-uk");
                
                CreateTrackingParams createTrackingParams2 = new CreateTrackingParams();
                createTrackingParams2.setTrackingNumber("H001EA0111477070");
                createTrackingParams2.setCourierCode("hermes-uk");
...
Get status of the shipment:
    ...
    public class GetEvriTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                // trackingParams.setTrackingNumbers("HZYEJA0393647455,H001EA0111477070");
                trackingParams.setCourierCode("hermes-uk");
...
Update a tracking by ID:
    ...
    public class UpdateEvriTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                String idString = "97a7b2ce9e626b2efccee02e084efe91";
